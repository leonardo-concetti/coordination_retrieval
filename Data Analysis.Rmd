...
hist_mv <- ggplot(
  ...
  geom_histogram(alpha = 0.6, binwidth = 50, color = "black", fill = "blue") +
  scale_x_continuous(breaks = seq(0, max(mv$rt), by = 500)) +
  labs(x = "Reading Time (ms)", y = "Density") +
...
Using this custom transform slightly improved the normality of the residuals, but it seems that no transform will make them perfectly normal at this point. Considering this and also the fact that nothing changes in terms of magnitude or significance of the fixed effect of interest, I will stick with the log-transform. 
