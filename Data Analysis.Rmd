...
H0: Detailed hierarchical information are not encoded in the WM entry of each items. There is no &P entry in Working memory and are can thus not be the target for retrieval. No difference in Reading Times is expected on the main verb in the two conditions. 
