...
*Lower-accuracy participants (< 85% or suspect combo of ACCxRT):* 
...
*Participants with ~ 75% acc on experimental items or weird RTs:* 
...
**We can decide to drop any participant with <70% accuracy on experimental items --> this would exclude subjects 9, 86, 173**
...
**Also consider removing subject 199 or seeing if he has some impact on the results of the analysis**
...
length(unique(dat$trial)) / length(unique(dat$subj))  #the result should be equal to the number of experimental items
