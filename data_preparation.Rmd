...
dat <- dat |> 
  select(subj, list, trial, item, condition, roi_number, roi_value, rt, sentence, question, answer, selection, correct)  #remember to add here any other column that you did not remove from the df
